...
export default function Index() {
  ...
  return (<>
    <div className="hero min-h-screen" style={{ backgroundImage: "url(https://i.imgur.com/aj5GyvD.png)" }}>
      ...
      <div className="hero-content text-center text-neutral-content flex-col">
        <div className="max-w-md">
          ...
          <p className="mb-5">Bienvenides al Plan de Estudios Interactivo de la Universidad Empresarial Siglo 21.</p>
        </div>
